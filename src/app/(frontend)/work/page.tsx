...
const projects = [
  {
    ...
    description: "A responsive and minimalistic portfolio website",
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorksSliderBtns
                ...
                btnStyles="bg-accent hover:bg-accent text-primary text[-22px] w-[44px] h-[44px] flex justify-center items-center transistion -all"
              />
            </Swiper>
          </div>
        </div>
